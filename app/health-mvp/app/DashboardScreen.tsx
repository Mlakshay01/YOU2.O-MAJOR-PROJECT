...
import { getTodayActivity } from "../src/storage/activityStorage";
import { computeMoodScore7 } from "../src/logic/score";

import { useFocusEffect, useRouter } from "expo-router";

import StepTracker from "../src/components/StepTracker";
import HydrationTracker from "../src/components/HydrationTracker";
import SleepLogger from "../src/components/SleepLogger";
...
useEffect(() => {
  ...
  return (
    ...
    >
      ...
      >
        <View>
          <Text style={{ fontSize: 28, fontWeight: "800" }}>Hi!</Text>
          <Text style={{ color: "#777" }}>{today}</Text>
        </View>
...
<TouchableOpacity onPress={() => router.push("/profile")}>
  ...
  />
      ...
      >
        <Text style={{ fontWeight: "700", marginBottom: 10, color: "#2a8c82" }}>
          Wellness Score
        </Text>
        <View
          style={{
      ...
      >
        ...
        <Metric title="Mood">
          <Text style={{ fontWeight: "700" }}>{moodText}</Text>
        </Metric>
      </View>
      ...
      >
        ...
        >
          ...
          <Text style={{ color: "#555" }}>Hydration improves energy</Text>
        </View>
      </View>
      ...
      >
        <Text style={{ fontWeight: "800" }}>Today's Mood</Text>
        <Text style={{ fontSize: 24, fontWeight: "900", marginTop: 6 }}>
          {moodText}
        </Text>
        <Text style={{ color: "#666" }}>Confidence: {confText}</Text>
      </View>
    </ScrollView>
  );
}
